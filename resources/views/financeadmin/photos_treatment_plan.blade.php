                ...
                <div class="card p-3 mt-3">
                    <div class="container-fluid px-4">
                       ...
                       <nav class="nav nav-borders">
                            <a class="nav-link" href="{{ url('/salesadmin/treatmentplan/edit/'.$treatment_plan->id) }}"><i class="fa fa-user"></i> Patient Information</a>
                            <a class="nav-link active ms-0" href="{{ url('/salesadmin/treatmentplan/edit/'.$treatment_plan->id.'?page=photos') }}"><b>{{ $photosCount }}</b> Photos @if(!$hasPhotos) <i class="fa fa-ban"></i> @else <i class="fa fa-check"></i> @endif</a>
                            <a class="nav-link {{ ($treatment_plan->post_time == NULL)? "disabled" : "" }}" href="{{ url('/salesadmin/treatmentplan/edit/'.$treatment_plan->id.'?page=doctor_recommended') }}">Doctor's Advice</a>
                        </nav>
                        <hr class="mt-0 mb-4">
                        <div class="row">
                            <div class="col-xl-4">
