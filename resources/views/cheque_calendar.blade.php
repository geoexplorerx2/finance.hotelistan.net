                ...
                <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                    ...
                    <div class="card-header flex-wrap border-0 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">Çek Takvimi</h3>
                        </div>
                    </div>
        ...
        <script>
            $(document).ready(function(){
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    dayMaxEvents: false,
                    events: [
                        @foreach($listCountByMonth as $cheque)
                        {
                            title: '{{ $cheque->countR }} {{ $cheque->name }}, {{ $cheque->amount }} {{ $cheque->currency }}',
                            start: '{{ $cheque->date }}',
                            description: '{{ $cheque->countR }} {{ $cheque->name }}',
                            end: '{{ $cheque->date }}',
                            color: '#000',
                            url: '{{ url('/chequesbydate?s='.$cheque->date) }}',
                            textColor: '#fff',
                        },
                        @endforeach
                    ],
