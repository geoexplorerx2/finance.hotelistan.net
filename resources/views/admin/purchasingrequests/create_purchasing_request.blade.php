                    ...
                    <div class="row">
                        <div class="offset-xxl-2 col-xxl-8">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productTitle" name="productTitle" placeholder="Ürün Başlığı" value="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                            <label for="productUrl">Ürün URL'si</label>
                                            <input type="text" class="form-control" id="productUrl" name="productUrl" placeholder="Ürün URL'si" value="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="note" name="note" placeholder="Açıklama" rows="3" cols="50" value=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="pb-5" data-wizard-type="step-content"  id="step2">
                                    <h4 class="mb-10 font-weight-bold text-dark">Ayrıntılarınızı İnceleyiniz ve Gönderiniz</h4>
                                    <h6 class="font-weight-bolder mb-3">Ürün Başlığı</h6>
                                    <div class="text-dark-50 line-height-lg">
                                        <div class="product-title"></div>
                                    </div>
                                    <div class="separator separator-dashed my-5"></div>
                                    <h6 class="font-weight-bolder mb-3">Ürün URL'si:</h6>
                                    <div class="text-dark-50 line-height-lg">
                                        <div class="product-url"></div>
                                    </div>
                                    <div class="separator separator-dashed my-5"></div>
                                ...
                                <div class="d-flex justify-content-between border-top mt-5 pt-10">
                                    ...
                                    <div>
                                        <button type="button" id="completePurchasingRequest" class="btn btn-success font-weight-bolder text-uppercase px-9 py-4" data-wizard-type="action-submit">Tamamla</button>
                                        <button type="button" id="savePurchasingRequestBtn" class="btn btn-primary font-weight-bolder text-uppercase px-9 py-4" data-wizard-type="action-next">İleri <i class="fa fa-arrow-right"></i></button>
                                    </div>
                                </div>
                        </div>
                    </div>
