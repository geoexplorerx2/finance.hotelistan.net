                    ...
                    <div class="container-fluid px-4">
                        <p class="text-white tp-status" style="background-color: {{ $treatment_plan->status->status_color }}">Tedavi Planı Durumu: {{ $treatment_plan->status->status_name }}</p>
                         <nav class="nav nav-borders">
                            <a class="nav-link" href="{{ url('/doctor/treatmentplan/edit/'.$treatment_plan->id) }}"><i class="fa fa-user"></i> Hasta Detayları</a>
                            ...
                            <a class="nav-link active ms-0" href="{{ url('/doctor/treatmentplan/edit/'.$treatment_plan->id.'?page=doctor_recommended') }}">Doktor Önerileri</a>
                        </nav>
                        <hr class="mt-0 mb-4">
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">Doktor Önerileri</div>
                                            ...
                                            <div class="col-12 col-lg-12 col-xl-12">
                                                <ul class="list-group">
                                                    <li class="list-group-item">
                                                        Önerilen Tedavi: <b>{{ $treatment_plan->recommendedTreatment->treatment_name }}</b>
                                                    </li>
                                                    <li class="list-group-item">
                                                        Operasyona Uygun mu? <b>@if($treatment_plan->is_suitable == 1) Evet @else Hayır @endif</b>
                                                    </li>
                                                    <li class="list-group-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="doctorExplanation" placeholder="Doktor Yorumu" required>{{ $treatment_plan->doctor_explanation }}</textarea>
                            </div>
                        </div>
                         <div class="col-lg-12 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_suitable" value="1" id="flexRadioDefault1" @if($treatment_plan->is_suitable == 1){{ "checked" }}@else @endif>
                                    <label class="form-check-label" for="flexRadioDefault1">Evet</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="is_suitable" value="0" id="flexRadioDefault2" @if($treatment_plan->is_suitable == 0){{ "checked" }}@else @endif>
