                ...
                <div class="card p-3 mt-3">
                    <div class="container-fluid px-4">
                       ...
                       <nav class="nav nav-borders">
                            ...
                            <a class="nav-link active ms-0" href="{{ url('/doctor/treatmentplan/edit/'.$treatment_plan->id.'?page=photos') }}"><b>{{ $photosCount }}</b> Fotoğraflar @if(!$hasPhotos) <i class="fa fa-ban"></i> @else <i class="fa fa-check"></i> @endif</a>
                            <a class="nav-link {{ ($treatment_plan->post_time == NULL)? "disabled" : "" }}" href="{{ url('/doctor/treatmentplan/edit/'.$treatment_plan->id.'?page=doctor_recommended') }}">Doktor Önerileri</a>
                        </nav>
                        <hr class="mt-0 mb-4">
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">Fotoğraflar</div>
                            ...
                            <div class="col-xl-8 col-lg-12 col-12 col-sm-12">
                                <div class="card mb-4">
                                    <div class="card-header">Fotoğraflar</div>
