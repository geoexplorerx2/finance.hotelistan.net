...
class RolePermissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('roles.index')->with('message', 'Yeni Rol Başarıyla Eklendi!');
        }
        catch (\Throwable $th) {
            throw $th;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('roles.index')->with('message', 'Rol İzinleri Başarıyla Güncellendi');
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('roles.index')->with('message', 'Rol Başarıyla Silindi!');
        }
        catch (\Throwable $th) {
            throw $th;
        }
